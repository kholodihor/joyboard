...
const Header = () => {
  ...
  return (
    <header className="bg-[#232323] text-white shadow">
      <nav className="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
        ...
        {session.status !== 'authenticated' ? (
          <Link href="/login" className="text-md font-semibold leading-6">
            Log in
          </Link>
        ) : (
          <div className="flex items-center gap-4">
            <Link href="/boards" className="text-md font-semibold leading-6">
              Boards
            </Link>
            <div
              onClick={event => {
